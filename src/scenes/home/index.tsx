            ...
            >
                ...
                <div className='z-10 mt-32 md:basis-3/5'>
                    ...
                    >
                        ...
                        <p className='mt-8 text-sm'>Univaled Gym, Unparalled Training Fitness Classes. World Class Studies to get the Body Shapes That ypu Dream of.. Get Your Dream Body Now.

                        </p>
                    </motion.div>

                    {/* ACTIONS */}
                    <motion.div className='mt-8 flex items-center gap-8 md:justify-start text-sm'
                        initial="hidden"
                        whileInView="visible"
                        viewport={{ once: true, amount: 0.5 }}
